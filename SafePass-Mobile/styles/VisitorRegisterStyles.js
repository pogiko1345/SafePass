...
export default StyleSheet.create({
  ...
  registerPaneDesktop: {
    ...
    borderColor: "#D8E8FF",
    ...(isWeb && {
      boxShadow: "0px 22px 54px rgba(15, 23, 42, 0.12)",
    }),
  },
  registerFormPane: {
    width: "100%",
  },
  registerFormPaneDesktop: {
    flex: 1.55,
    backgroundColor: "#FFFFFF",
  ...
  existingAccountLoginText: {
    fontSize: fontSizes.base,
    fontWeight: "900",
    color: "#FFFFFF",
  },
  existingAccountEditButton: {
    minHeight: 46,
    borderRadius: 16,
    backgroundColor: "#F8FBFE",
    borderWidth: 1,
  ...
  otpInput: {
    ...
    borderRadius: 10,
    paddingHorizontal: spacing.sm,
    paddingVertical: Platform.select({ ios: 12, android: 10, web: 10 }),
    fontSize: fontSizes.base,
    fontWeight: "800",
    letterSpacing: 4,
    color: "#0F172A",
